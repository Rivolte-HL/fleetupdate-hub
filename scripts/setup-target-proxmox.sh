...
echo ""
echo "💡 Note pour le déploiement physique des paquets (dist-upgrade) :"
echo "Pour permettre à FleetUpdate-Hub d'exécuter 'apt-get dist-upgrade' sur le nœud Proxmox,"
echo "renseignez également vos identifiants SSH (root ou utilisateur sudo sans mot de passe)."
