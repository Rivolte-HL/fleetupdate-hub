...
export const RollbackConfirmModal: React.FC<RollbackConfirmModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/75 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="w-full max-w-md rounded-3xl border border-rose-500/30 overflow-hidden shadow-2xl p-6 space-y-5 bg-[#0c1424] text-slate-100 shadow-rose-950/20">
