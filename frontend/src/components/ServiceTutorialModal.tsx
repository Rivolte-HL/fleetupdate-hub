...
export const ServiceTutorialModal: React.FC<ServiceTutorialModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/75 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="w-full max-w-4xl rounded-3xl border border-cyan-500/30 overflow-hidden shadow-2xl flex flex-col max-h-[90vh] bg-[#0c1424] text-slate-100 shadow-cyan-500/10">
        {/* Header */}
