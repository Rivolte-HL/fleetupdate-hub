...
import { LayoutDashboard, Server, History, KeyRound, ShieldAlert, ShieldCheck, BookOpen, ChevronRight } from 'lucide-react';
...
export const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { to: '/hosts', label: 'Parc & Équipements', icon: Server },
    { to: '/updates', label: 'Mises à Jour & Tâches', icon: History },
    ...(isAdmin
      ? [
          { to: '/vault', label: 'Coffre de Secrets', icon: KeyRound },
          { to: '/audit', label: 'Journaux d’Audit', icon: ShieldAlert }
        ]
      : [])
  ];
        ...
        <div className="space-y-6">
          ...
          <div className="px-2">
            ...
            >
              ...
              <span className="text-[10px] px-1.5 py-0.5 rounded bg-amber-500/20 text-amber-300 font-mono">6 services</span>
            </button>
          </div>
        </div>
