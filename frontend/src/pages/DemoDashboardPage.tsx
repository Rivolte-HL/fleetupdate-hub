...
export const DemoDashboardPage: React.FC = () => {
  ...
  const mockHosts: Host[] = [
    ...
    {
      id: 'demo-truenas-1',
      name: 'truenas-scale-storage01',
      adapterType: 'TRUENAS',
      endpointUrl: 'https://192.168.1.150',
      isOnline: true,
      currentVersion: 'TrueNAS-SCALE-24.10.0 (3 apps)',
      targetVersion: 'OS: 24.10.1 | +2 app(s) to upgrade',
      availableUpdatesCount: 3,
      requiresReboot: true,
      lastCheckAt: new Date().toISOString(),
      createdAt: '2026-08-01T00:00:00Z',
      updatedAt: '2026-08-20T18:00:00Z',
      metadata: {
        osVersion: 'TrueNAS SCALE 24.10.0 (Electric Eel)',
        zfsPool: 'tank (RAID-Z2, Healthy, 48TB)',
        snapshotDataset: 'boot-pool',
        appsWithUpdateCount: 2,
        apps: [
          {
            id: 'nextcloud',
            name: 'Nextcloud Hub',
          ...
          },
          {
            ...
            status: 'RUNNING',
            currentVersion: '1.40.2',
            targetVersion: '1.40.2',
            hasUpdate: false,
            type: 'DOCKER_APP'
          }
        ]
